...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("dashboard/raf-logo.png"
                 , width=100)
    with col3:
        st.write(' ')
...
with tab2:
    ...
    with st.expander("See Explanation"):
        st.write('Based on the visualization, there is a higher concentration of customers in the southeast and south regions. In addition, the data shows that the number of customers is greater in metropolitan cities such as São Paulo, Rio de Janeiro, Porto Alegre, and so on.')

st.caption('Copyright (C) Sulthan Akmal Rafliansyah 2024')
